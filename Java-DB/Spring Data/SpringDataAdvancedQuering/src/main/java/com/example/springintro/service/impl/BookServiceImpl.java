...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public List<String> findAllGoldenBooksLessThat5000Copies() {
    ...
    @Override
    public List<String> findAllBooksWithPriceLowerThat5AndHigherThat40() {
    ...
    @Override
    public List<String> findAllBooksNotReleasedInThisYear(int releaseDate) {
        LocalDate lower = LocalDate.of(releaseDate, 1, 1);
        LocalDate higher = LocalDate.of(releaseDate, 12, 31);

        return bookRepository.findAllByReleaseDateBeforeOrReleaseDateAfter(lower, higher)
                .stream()
                .map(Book::getTitle)
                .collect(Collectors.toList());
    }
    ...
    @Override
    public List<String> findAllBooksContaining(String input) {
    ...
    @Override
    public List<String> bookTitleSearch(String input) {
        return bookRepository.findAllByAuthor_LastNameStartsWith(input)
                .stream()
