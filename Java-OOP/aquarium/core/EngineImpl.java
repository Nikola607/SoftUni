...
public class EngineImpl implements Engine {
    ...
    private String addAquarium(String[] data) {
        String type = data[0];
        String name = data[1];
        return controller.addAquarium(type, name);
    }

    private String addDecoration(String[] data) {
        String decoration = data[0];
        return controller.addDecoration(decoration);
    }

    private String insertDecoration(String[] data) {
        String aquariumName = data[0];
        String decoration = data[1];
        return controller.insertDecoration(aquariumName, decoration);
    }
